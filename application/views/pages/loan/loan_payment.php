     ...
     <table id="listClients" class="display mydatatable" style="width:100%">
        ...
        <?php if(!empty($paymentList)){ 
            ...
            ?>
                ...
                <td> <input type="" class="paymentAmount" hidden name="loanAmount[<?= $list->loan_accountID ?>]" value="<?= $list->paymentDue ?>"> <?= round($list->paymentDue,4) ?> </td>
                <td> <input type="number" class="paymentCollection" name="collection[<?= $list->loan_accountID ?>]"> </td>
                </tr>
                <?php 
            }
        } ?>
